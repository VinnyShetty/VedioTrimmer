 ...
 * the License.
 */
package com.marolix.videotrimmer.utils;
...
public final class BackgroundExecutor {
    ...
    public static abstract class Task implements Runnable {
        ...
        private void postExecute() {
            ...
            synchronized (com.marolix.videotrimmer.utils.BackgroundExecutor.class) {
				/* execution complete */
                TASKS.remove(this);
                ...
                if (serial != null) {
                    ...
                    if (next != null) {
                        ...
                        com.marolix.videotrimmer.utils.BackgroundExecutor.execute(next);
                    }
                }
            }
        }
